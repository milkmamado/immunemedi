      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mt-4">
            <span className="font-sans">20</span>인 이상의 전문 의료진이
            <br className="hidden sm:block" />
            함께합니다
          </h2>
        </motion.div>

        {/* Team photo + specialties */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={inView ? { opacity: 1, y: 0 } : {}}
        ...
        >
          {/* Team image */}
          <div className="relative overflow-hidden rounded-2xl shadow-card aspect-[4/3]">
            <img
              src={doctorsTeamImg}
              alt="면력한방병원 의료진 단체 사진"
          ...
          <div>
            <p className="text-lg text-muted-foreground mb-8 leading-relaxed">
              면력한방병원은 한방내과, 한방부인과, 한방재활의학과 등 각 분야 전문의들이
              협진하여 환자 한 분 한 분에게 최적의 회복 치료를 제공합니다.
            </p>
