...
import treatNkCell from "@/assets/treat-nk-cell.jpg";
...
const westernTreatments: Treatment[] = [
  ...
  { title: "글루타민 요법", desc: "면역세포 기능 향상 및 근손실 예방, 항암 부작용 완화에 효과", image: treatGlutamine },
  { title: "NK세포치료제", desc: "배양된 NK세포로 암세포만 선택 공격, 수술 후 미세암 제거에 도움", image: treatNkCell },
  { title: "고농도 비타민 C 요법", desc: "항노화 핵산 합성을 촉진하고 말초신경 염증 및 메스꺼움을 완화", image: "/placeholder.svg" },
  { title: "글루타치온", desc: "영양제 효과를 촉진하고 항암제로 인한 신경성 통증을 감소", image: "/placeholder.svg" },
  { title: "셀레늄 요법", desc: "활성산소를 제거하고 항산화 작용으로 암세포 자연사멸을 유도", image: "/placeholder.svg" },
  { title: "비타민 B6", desc: "단백질 대사를 돕고 메스꺼움·근육경련·말초신경 염증을 완화", image: "/placeholder.svg" },
  { title: "비타민 B12", desc: "DNA 합성을 보조하고 호모시스테인을 분해하여 심혈관 건강에 기여", image: "/placeholder.svg" },
  { title: "영양관리 요법", desc: "경구 영양이 불충분한 경우 필수 에너지·지방산·오메가-3 등을 공급", image: "/placeholder.svg" },
];
...
const orientalTreatments: Treatment[] = [
  ...
  { title: "면역플러스", desc: "황기 부정단 처방으로 종양 면역 세포 활성화를 촉진, 골수기능 개선 및 종양 증식 억제", image: "/placeholder.svg" },
  { title: "항암플러스", desc: "옻나무 추출 천연물질로 루시올 함량을 높여 항암 효과 증진", image: "/placeholder.svg" },
  { title: "청간플러스", desc: "과산화지질 생성을 감소시켜 간 손상을 보호하고 간 기능을 개선", image: "/placeholder.svg" },
  { title: "면역약침", desc: "멸균된 순수 한약재를 침으로 직접 투여하여 약과 침의 동시 효과, 항암 부작용 완화", image: "/placeholder.svg" },
];
