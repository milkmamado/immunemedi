...
const westernTreatments: Treatment[] = [
  ...
  { title: "NK세포치료제", desc: "몸속 면역세포를 배양시킨 살해 세포로써 암세포만을 선택적으로 공격. 환자 본인에게만 투여할 수 있는 항암제로, 수술 이후의 미세암 제거에도 도움", image: treatNkCell },
...
const orientalTreatments: Treatment[] = [
  { title: "신종단", desc: "공개 특허받은 항암단의 가감 처방. 림프순환장애 및 부종 치료 목적으로 인진호, 택사, 적복령 등을 처방", image: "/placeholder.svg" },
  { title: "항암단", desc: "곡기생, 산자고 등의 약재로 담음·어혈을 제거하고 종양 활성을 억제. 임상에서 신생혈관 수치가 유의미하게 감소", image: "/placeholder.svg" },
  { title: "면역플러스", desc: "황기 부정단 처방으로 종양 면역 세포의 활성화 촉진. 면역기능 증강, 골수기능 개선 및 종양 증식 억제", image: "/placeholder.svg" },
  { title: "항암플러스", desc: "옻나무 추출 진액에서 알레르기 성분을 제거하고 루시올 함량을 높인 천연물질로 암 치료 효과 증진", image: "/placeholder.svg" },
  { title: "청간플러스", desc: "간 기능 저하 시 과산화지질 생성을 감소시켜 간 손상을 보호하고 중성지방 수치를 개선", image: "/placeholder.svg" },
  { title: "면역약침", desc: "멸균된 순수 한약재를 침을 통해 직접 투여. 약과 침의 동시 효과로 항암 부작용을 완화", image: "/placeholder.svg" },
];
