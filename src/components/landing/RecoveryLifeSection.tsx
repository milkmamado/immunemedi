...
const programs = [
  { icon: "🚶", title: "산책 프로그램", freq: "매일 평일 오전", desc: "병원 인근 야외 산책 버스 운행 — 자연 속 심리적 회복", image: recoveryNature, imageAlt: "산책 프로그램" },
  { icon: "🌸", title: "소풍 프로그램", freq: "매주 1회", desc: "병원 밖 힐링 소풍 — 한국 문화 체험 + 정서적 회복", image: lifeOuting, imageAlt: "소풍 프로그램 — 한국 사찰 방문" },
  { icon: "🏃", title: "운동치료", freq: "매주 1회", desc: "전문 치료사와 함께하는 운동 — 체력 회복 + 재활", image: lifeExercise, imageAlt: "운동치료 프로그램" },
  { icon: "🎨", title: "원데이클래스", freq: "매주 1회", desc: "주제별 다양한 클래스 — 즐거움 + 정서 치유", image: lifeOuting, imageAlt: "원데이클래스 활동" },
  { icon: "🍱", title: "푸드테라피", freq: "2주 1회", desc: "전문 셰프 + 임상 영양사 협업 — 영양 관리 + 미식 경험", image: lifeFood, imageAlt: "푸드테라피 건강식" },
];
